<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmployeeMaster.aspx.cs" Inherits="NavnathWebsite.Masters.EmployeeMaster" %>
        ...
        <div class="col-lg-12 col-md-12">
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">Search Empoyee</h3>
                            ...
                            <tr>
                                <td width="5%">
                                    <asp:RadioButton ID="radNameWise" runat="server" GroupName="Searchemp" 
                                        Checked="true" oncheckedchanged="radNameWise_CheckedChanged" 
                   ...
                   <table class="table-condensed table-hover table-responsive" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="35%">
                                    <asp:Button ID="btnBrowsePhoto" runat="server" Text="Browse" 
                                        CssClass="btn btn-primary"></asp:Button>&nbsp;&nbsp;<asp:Button ID="btnUploadPhoto" runat="server" Text="Upload" CssClass="btn btn-success"></asp:Button>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td width="35%"><asp:TextBox ID="txtDateOfJoin" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                                                    ...
                                                    TargetControlID="txtDateOfJoin" Format="MM/dd/yyyy" >
                            ...
                            <tr>
                                ...
                                <td width="35"><asp:TextBox ID="txtLastName" runat="server" CssClass="form-control input-sm" Width="510px"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <div class="input-group">
                                        ...
                                        <asp:TextBox ID="txtEmailID" runat="server" CssClass="form-control input-sm" OnTextChanged="txtEmailID_TextChanged" ></asp:TextBox>
                                </div>
                            ...
                            <tr>
                                <th width="15%">CTC</th>
                                <td width="35"><asp:TextBox ID="txtCTC" runat="server" CssClass="form-control input-sm" Width="518px"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td width="35"><asp:TextBox ID="txtGrossAmount" runat="server" CssClass="form-control input-sm" Width="520px"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td width="35"><asp:TextBox ID="txtTempAddress" runat="server" CssClass="form-control input-sm" Width="520px"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td width="35"><asp:TextBox ID="txtDocumentName" runat="server" CssClass="form-control input-sm" Width="515px"></asp:TextBox>
                                ...
                                <td width="35%"><asp:TextBox ID="txtAsset" runat="server" CssClass="form-control input-sm" OnTextChanged="txtAsset_TextChanged"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td width="35%"><asp:TextBox ID="txtLeftDate" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                                                    ...
                                                    TargetControlID="txtLeftDate" Format="MM/dd/yyyy" >
                                                    </cc1:CalendarExtender>
                                </td>
                            </tr>
            ...
            <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <asp:Button ID="btnEmployeeWise" runat="server" CssClass="btn btn-warning" Text="Employee Wise Report" OnClick="btnEmployeeWise_Click" />
                        <asp:Button ID="btnAllEmployee" runat="server" CssClass="btn btn-warning" Text="All Employee Report" OnClick="btnAllEmployee_Click" />
                    </div>
