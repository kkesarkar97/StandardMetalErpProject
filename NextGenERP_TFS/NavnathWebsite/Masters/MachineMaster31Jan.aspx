<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MachineMaster31Jan.aspx.cs" Inherits="NavnathWebsite.Masters.MachineMaster31Jan" %>
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-4">
                        ...
                        <asp:DropDownList ID="drpMachineCode" runat="server" 
                            ...
                            AutoPostBack="True" 
                            onselectedindexchanged="drpMachineCode_SelectedIndexChanged1">
                        </asp:DropDownList>
                    </div>
                    <div class="col-md-4">
                          ...
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage=" Please Enter Machine Code" 
                                ...
                                <td width="35%">
                                    <asp:TextBox ID="txtItemMaterial" runat="server" 
                                        ...
                                        ValidationGroup="G1" ontextchanged="txtItemMaterial_TextChanged"></asp:TextBox>
...
<asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="Duplicate Machine Name Entered" 
                                        ...
                                        ValidationGroup="G1" onservervalidate="CustomValidator1_ServerValidate">Machine Name Already Exixst.......!</asp:CustomValidator>
              ...
              <div class="box-body">
                 ...
                 <table class="table-condensed table-hover table-responsive" width="100%">
                        ...
                        <ajx:CalendarExtender ID="CalendarExtender1" runat="server" 
                                TargetControlID="TextBox5"></ajx:CalendarExtender>
