<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SupplierMasterN.aspx.cs" Inherits="NavnathWebsite.Masters.SupplierMasterN" %>
                ...
                <div class="box-body">
                    <div class="col-md-4">
                        ...
                        <asp:DropDownList ID="drpSearchSupplier" runat="server" 
                            CssClass="form-control select2"  AutoPostBack="true" OnSelectedIndexChanged="drpSearchSupplier_SelectedIndexChanged" 
                            >
