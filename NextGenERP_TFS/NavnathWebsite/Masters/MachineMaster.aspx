<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MachineMaster.aspx.cs" Inherits="NavnathWebsite.Masters.MachineMaster" %>
...
<section id="ItemSearch">
  ...
  <tr>
                                <th width="15%"> <asp:Label ID="Label3" runat="server" Text="Manual Code"></asp:Label> </th>
                                <td width="35%">
                                    <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control input-sm" 
                                        meta:resourcekey="txtItemManufResource1"></asp:TextBox></td>
                                <th width="15%"> <asp:Label ID="Label4" runat="server" Text="Manual Name"></asp:Label> </th>
                                <td width="35%">
