...
namespace DAL
{
    public class ItemMaster_10May_DAL : ConncetionClass
    {
       ...
       //
         ...
         public int Save_ItemMaster_10May(ItemMaster_10May_Model model)
        {
            ...
            try
            {
                ...
                {
                    cnUniversal.Open();
                    cmdUniversal = new SqlCommand("Save_ItemMaster_10May_AARTI", cnUniversal);
        ...
        public int Update_ItemMaster_10May(ItemMaster_10May_Model model)
        {
            ...
            try
            {
                ...
                {
                    cnUniversal.Open();
                    cmdUniversal = new SqlCommand("Update_ItemMaster", cnUniversal);
                    cmdUniversal.CommandType = CommandType.StoredProcedure;
                    SqlCommandBuilder.DeriveParameters(cmdUniversal);
        ...
        {
            {
                ...
                using (cnUniversal)
                {
                    cmdUniversal.CommandText = "Search_ItemMaster";
